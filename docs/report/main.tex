...
% -------------------------------------------------
% CHAPTER AND PAGE FORMATTING
% -------------------------------------------------

% Center Chapter Headings and remove gap
...
% Ensure chapter start pages also have bottom-right numbering
...
\vspace{1cm}
A Report submitted in partial fulfillment of the requirements for the internal assessment of the course

\vspace{1cm}

{\large \textbf{Wireless Communication}}
...
\textbf{
Nikhil VGK (112316031) \\
Visweswar Reddy Avva(112316009) \\
Bagal Vinit Ratnakar(112316010) \\
Sangamesh Patanshetti(112316041) \\
Bhavya Chandanani(112316012)
}

\vspace{1cm}

Under the Supervision of: \textbf{Dr. Sushant Kumar}
...
Wireless communication networks often experience severe performance degradation during emergencies, natural disasters, infrastructure failures, and sudden traffic surges. In such situations, conventional terrestrial base stations may become overloaded or non-operational, resulting in coverage gaps and reduced quality of service. This project presents an energy-aware online positioning framework for Unmanned Aerial Vehicle Base Stations (UAV-BSs) in dynamic wireless networks.

The proposed system focuses on the real-time deployment and repositioning of UAV-BSs to maximize network coverage, maintain communication reliability, and optimize energy consumption. By continuously adapting to changing user distributions and network conditions, the UAV-BS can efficiently support affected regions and improve overall network performance. The framework considers factors such as user density, communication range, mobility, and UAV battery limitations while determining optimal positioning strategies.

The project highlights the importance of intelligent UAV positioning in next-generation wireless communication systems and demonstrates how adaptive aerial base stations can enhance network resilience and service continuity during critical scenarios. The proposed approach aims to provide an efficient, flexible, and scalable solution for dynamic network environments.

\vspace{0.5cm}

\noindent \textbf{Keywords:} UAV-BS, Wireless Communication, Dynamic Networks, Energy Optimization, Online Positioning, Unmanned Aerial Vehicle, Emergency Communication.
% =================================================
% INTRODUCTION
% =================================================
...
Figure~\ref{fig:workflow} illustrates the workflow of the proposed algorithm in \cite{pijnappel2024online}.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{workflow.png}
    \caption{Workflow of the baseline UAV positioning algorithm}
    \label{fig:workflow}
\end{figure}% =================================================
% SIMULATION SETUP
% =================================================
...
vol. 73, no. 4, pp. 5572--5586, 2024.
doi: 10.1109/TVT.2023.3329960.

\bibitem{erep2020}
Hugo Rodrigues, André Coelho, Manuel Ricardo, and Rui Campos,
``Energy-aware relay positioning in flying networks,''
\textit{International Journal of Communication Systems},
vol. 35, no. 13, 2022.
doi: 10.1002/dac.5233.

\bibitem{rl_placement}
Rozhina Ghanavi, Elham Kalantari, Maryam Sabbaghian,
Halim Yanikomeroglu, and Abbas Yongacoglu,
``Efficient 3D aerial base station placement considering users mobility by reinforcement learning,''
in \textit{Proc. IEEE Wireless Communications and Networking Conference (WCNC)},
2018, pp. 1--6.
doi: 10.1109/WCNC.2018.8377340.

\bibitem{mozaffari2019tutorial}
Mohammad Mozaffari, Walid Saad, Mehdi Bennis,
Young-Han Nam, and Mérouane Debbah,
...
in \textit{Proc. IEEE 84th Vehicular Technology Conference (VTC-Fall)},
2016, pp. 1--6.
...
Tech. Rep. 38.901 v16.1.0,
Sophia Antipolis, France, 2019.
